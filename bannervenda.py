...
class BannerVenda(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        esquerda_label = Label(text=cliente.capitalize(), size_hint=(1, 0.2), pos_hint={"right": 1, "top": 0.2})
        ...
        meio_label = Label(text=produto.capitalize(), size_hint=(1, 0.2), pos_hint={"right": 1, "top": 0.2})
        ...
        direita_label_quantidade = Label(text=f"{quantidade:,.1f} {unidade}", size_hint=(1, 0.33), pos_hint={"right": 1, "top": 0.4})
